...
public class StreamEgJava8 {
	...
	public static void main(String[] args) {
		...
		List<String> strlist10 = strlist.stream().filter(str->str.length()>0).collect(Collectors.toList());
		System.out.println("Strings without empty string : " + strlist10);
		...
		System.out.println(" Avg  : "+intlist.stream().mapToInt(i->i).summaryStatistics().getAverage());	
	}
